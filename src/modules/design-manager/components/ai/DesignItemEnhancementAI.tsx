      ...
      const response = await fetch(`${API_BASE}/ai/design-item-enhancement`, {
        ...
        body: JSON.stringify({
          deliverable: {
            ...
            category: designItem.category || 'MANUFACTURED',
            ...
            <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-green-700">
                  ${result.aiEnhancement.estimatedCostRange.min.toLocaleString()} - ${result.aiEnhancement.estimatedCostRange.max.toLocaleString()}
                </span>
              </div>
