 ...
 * Rewritten for reliable scrolling and layout
 */
...
export function StrategyCanvas({ projectId, projectName, projectCode, clientBrief, userId, onClose }: StrategyCanvasProps) {
  ...
  // Report slide-out panel - rendered via portal to avoid layout issues
  const reportPanel = showReportPanel && generatedReport ? createPortal(
    <div
    ...
    >
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-2xl bg-white shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <section className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="flex-shrink-0 border-t border-gray-200 p-4 flex justify-between items-center bg-white">
          <button
            onClick={() => setShowReportPanel(false)}
    ...
    <div className="w-full">
      ...
      <div className="p-4 sm:p-6 pb-24">
        ...
        <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Project Strategy</h1>
            {projectName && (
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all disabled:opacity-50 text-sm"
            >
              {isGeneratingReport ? (
                <>
                  <div className="animate-spin rounded-full h-4 w-4 border-2 border-white border-t-transparent" />
            ...
            {generatedReport && !showReportPanel && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 border border-indigo-300 text-indigo-600 rounded-lg hover:bg-indigo-50 text-sm"
              >
        ...
        {/* Error Banners */}
        {(error || reportError) && (
          <div className="flex items-center justify-between p-3 bg-red-50 border border-red-100 rounded-lg mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column - Strategy Inputs (2/3 width on desktop) */}
          <div className="lg:col-span-2 space-y-6">
            {/* Project Scoping AI - START HERE */}
            <article className="bg-white rounded-xl shadow-lg border-2 border-purple-400 p-4 sm:p-6 bg-gradient-to-br from-purple-50 via-white to-purple-50">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex-1">
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Project Scoping AI</h2>
            ...
            {/* Challenges Section */}
            <article className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-md">
                  <Target className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <h2 className="text-lg sm:text-xl font-bold text-gray-900">Challenges & Goals</h2>
              </div>
              <ChallengesSection
            ...
            <article className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-md">
                  <Ruler className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <h2 className="text-lg sm:text-xl font-bold text-gray-900">Space Parameters</h2>
              </div>
            ...
            <article className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-md">
                  <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <h2 className="text-lg sm:text-xl font-bold text-gray-900">Budget Framework</h2>
              </div>
            ...
            <article className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-md">
                    <Lightbulb className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                  </div>
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">Research Findings</h2>
                </div>
                <span className="px-4 py-1.5 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 text-sm font-bold rounded-full">
          ...
          {/* Right Column - Research Assistant & Customer Intelligence (1/3 width on desktop) */}
          <div className="space-y-6">
            ...
            <article className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="flex items-center gap-4 p-6 border-b border-gray-100 bg-gradient-to-r from-blue-600 to-indigo-600">
